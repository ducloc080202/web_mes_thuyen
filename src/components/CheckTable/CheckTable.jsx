                                        ...
                                        return (
                                            <tr
                                                className={cl("group relative", {
                                                    ...
                                                    "!bg-primary-2 !text-neutron-4": row?.workOrderStatus == 2,
                                                })}
                                                    ...
                                                    >
                                                        ...
                                                        {onDeleteRow &&
                                                            ...
                                                            activeIndex === index && (
                                                                <i
                                                                    className={cl(
                                                                        "absolute right-2 top-[50%] h-[30px] w-[30px] translate-y-[-50%]",
                                                                        "flex items-center justify-center rounded-full text-neutron-4",
                                                                        "heading-20-b invisible  cursor-pointer bg-warning-1 group-hover:visible",
                                                                    )}
